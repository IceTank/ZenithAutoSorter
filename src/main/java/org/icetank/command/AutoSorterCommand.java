    ...
    public LiteralArgumentBuilder<CommandContext> register() {
        return command("autoSorter")
                .then(argument("toggle", toggle()).executes(c -> {
                    PLUGIN_CONFIG.sortModule.enabled = getToggle(c, "toggle");
                    ...
                    c.getSource().getEmbed()
                            ...
                            .title("Auto Sorter " + toggleStrCaps(PLUGIN_CONFIG.sortModule.enabled));
                }))
                .then(literal("sort")
                        .then(literal("pickupLocation").executes(c -> {
                            ...
                            PLUGIN_CONFIG.sortModule.pickupLocation = new BlockPos(result.block().x(), result.block().y(), result.block().z());
                            c.getSource().getEmbed()
                        ...
                        .then(literal("clear").executes(c -> {
                            PLUGIN_CONFIG.sortModule.sortDestinations.clear();
                            c.getSource().getEmbed()
